...
require 'db.php';
// Esta línea carga todas las librerías de Composer
require dirname(__DIR__) . '/vendor/autoload.php';

// --- LÍNEAS CLAVE CORREGIDAS ---
// Estas líneas le dicen a PHP cómo encontrar las clases de PHPMailer.
...
foreach ($users as $user) {
    ...
    if (empty($pending_tasks)) {
        echo "<p>El usuario no tiene tareas pendientes. No se envía correo.</p><hr>";
        continue;
    }
    ...
    try {
        // Configuración del servidor SMTP (recuerda usar tu contraseña de aplicación de Gmail)
        $mail->isSMTP();
